...
// This is where the SKILL is leveraged, so the cases are about the §8 gates: citations in
...
export const cases = [
  {
    ...
    why: '§8: specify the world and pose the situation. The baseline case must produce a saved prompt',
  },
  {
    ...
    why: '§8: duration, ratio and resolution are parameters, never prompt text — even when the person asks in those words',
  },
  {
    ...
    why: 'the shot has no refs, so ANY @ImageN citation is out of range (§3 invariant 2)',
  },
  {
    ...
    why: '§8 names dialogue preservation as a minimum gate — an altered line is a wrong take',
  },
  {
    ...
    why: '§7: requireSkillLine throws when a slot is unbound. There is no fallback and no house style',
  },
  {
