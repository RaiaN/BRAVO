...
export const gates = {
  ...
  // Every call names a tool the agent actually holds (row).
  ...
  // : an unknown id resolves to nothing. A tool result that errored on a bad id is a
  ...
  // duration/ratio/resolution in prompt text (— those are parameters, never text).
